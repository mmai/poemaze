...
export function renderShare(href, content){
  ...
  return h("div.share", [
    h('button.share-btn.trigger.reset', {attrs:{type:"button", "onclick": "document.getElementById('share-panel').classList.toggle('active')" }}, "Partager"),
    h("div#share-panel", [
        h("a", {attrs:{title: "Partager sur Facebook", href:"https://www.facebook.com/sharer/sharer.php?u=http%3A//arbre-integral.net" }}, [
        ...
        h("a", {attrs:{title: "Partager sur Twitter", href:`https://twitter.com/home?status=${twitterContent}`}}, [
            h('svg', {attrs:{width:"24", height:"28", viewBox:"0 0 24 28"}}, [
        ...
        h("a", {attrs:{title: "Partager par email", href:`mailto:entrez@une-adresse-ici.com?subject=L'arbre Integral&body=${mailContent}` }}, [
            h('svg', {attrs:{width:"24", height:"28", viewBox:"0 0 24 28"}}, [
